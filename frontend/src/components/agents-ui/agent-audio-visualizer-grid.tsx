...
const agentAudioVisualizerGridCellVariants = cva([
  'w-1 h-1 rounded-full bg-current/10 place-self-center transition-all duration-150 ease-out',
...
const agentAudioVisualizerGridVariants = cva('grid', {
  variants: {
    size: {
      icon: ['gap-[2px]'],
      sm: ['gap-[4px]'],
...
const sizeDefaults = {
  ...
  lg: 5,
  xl: 5,
} satisfies Record<VisualizerSize, number>;

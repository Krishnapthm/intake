...
import type { ComponentProps, Dispatch, ReactElement, ReactNode, SetStateAction } from "react";
import {
  createContext,
  memo,
  useCallback,
...
type MessageOrigin = "user" | "assistant";
...
export const Message = ({
  ...
  from,
  ...props
}: ComponentProps<"div"> & { from: MessageOrigin }) => (
  <div
    className={cn(
...
export const MessageBranchContent = ({
  ...
  return childrenArray.map((branch, index) => (
    <div
      ...
      key={(branch as ReactElement | null)?.key ?? index}
      {...props}>
      {branch}
    </div>
  ));
